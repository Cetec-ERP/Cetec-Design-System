...
}`,...(C=(E=m.parameters)==null?void 0:E.docs)==null?void 0:C.source}}};var L,F,O;p.parameters={...p.parameters,docs:{...(L=p.parameters)==null?void 0:L.docs,source:{originalSource:`{
  render: () => <Box display="flex" gap="4" alignItems="center">
...
}`,...(O=(F=p.parameters)==null?void 0:F.docs)==null?void 0:O.source}}};var M,U,H;x.parameters={...x.parameters,docs:{...(M=x.parameters)==null?void 0:M.docs,source:{originalSource:`{
  render: () => <Box display="flex" flexDir="column" gap="4">
...
}`,...(xe=(pe=I.parameters)==null?void 0:pe.docs)==null?void 0:xe.source}}};const Ae=["Default","Sizes","SizesWithLabels","Shapes","WithInitials","WithCustomFallback","ImageLoadError","Presence","PresenceAllSizes","Status","StatusAllSizes","PresenceAndStatus","UserList","ProjectAvatars","AvatarStack"];export{I as AvatarStack,i as Default,x as ImageLoadError,d as Presence,g as PresenceAllSizes,h as PresenceAndStatus,j as ProjectAvatars,c as Shapes,t as Sizes,o as SizesWithLabels,u as Status,f as StatusAllSizes,z as UserList,p as WithCustomFallback,m as WithInitials,Ae as __namedExportsOrder,Be as default};
