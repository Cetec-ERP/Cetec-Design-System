import{j as o}from"./jsx-runtime-D_zvdyIk.js";import{r as s}from"./index-BKyFwriW.js";import{w as k,u as v,e as l}from"./index-DPYJpPba.js";import{m as bo,c as yo,s as go,a as ho,g as vo,d as Ea,B as u,b as fo,e as xo}from"./dsComponent-BYUIyF_R.js";import{B as wo}from"./Button-Bf2hC955.js";import{F as Da}from"./FormField-C_O3noye.js";import{u as Bo,c as To,s as ko,b as Ro,d as Ao,e as Io,g as Oo,F as So,D as Co,h as Eo}from"./Tooltip-C_qN5a9y.js";import{d as Do}from"./dsPart-nnoJM9m6.js";import{S as jo}from"./Spinner-B6GigztE.js";import{m as Vo}from"./menu-DwQVg8hw.js";import{I as Lo}from"./Icon-Dq9uSEeo.js";import{L as Mo,a as Fo}from"./ListItem-DMiIZ9ni.js";import{C as Ho}from"./Chip-DiKGzQyA.js";import{u as qo}from"./FieldContext-D6URyQos.js";import"./_commonjsHelpers-CqkleIqs.js";import"./IconConfig-CikP2Rer.js";import"./Label-kmghWeo3.js";import"./Text-L8_4w38l.js";import"./index-CxmYaGqE.js";import"./index-DQw2Bw4b.js";import"./HighlightText-BP-sbDRA.js";import"./Checkbox-XnGrI6IT.js";import"./Divider-DhAaijX4.js";import"./Toggle-C_NcmSvJ.js";const ja={size:"md"},Po=[],No=[["root","autocomplete__root"],["control","autocomplete__control"],["valueContainer","autocomplete__valueContainer"],["input","autocomplete__input"],["token","autocomplete__token"],["overflowIndicator","autocomplete__overflowIndicator"],["loadingIndicator","autocomplete__loadingIndicator"],["listbox","autocomplete__listbox"],["status","autocomplete__status"],["liveRegion","autocomplete__liveRegion"]],_o=No.map(([e,t])=>[e,ho(t,ja,vo(Po,e))]),$o=bo((e={})=>Object.fromEntries(_o.map(([t,n])=>[t,n.recipeFn(e)]))),gt=["size"],zo=e=>({...ja,...yo(e)}),Ko=Object.assign($o,{__recipe__:!1,__name__:"autocomplete",raw:e=>e,classNameMap:{},variantKeys:gt,variantMap:{size:["sm","md","lg","xl"]},splitVariantProps(e){return go(e,gt)},getVariantProps:zo}),Va=e=>{const{activeIndex:t,baseId:n,density:i,floatingProps:c,floatingRef:p,floatingStyles:b,getItemProps:E,items:x,listboxClassName:R,listboxId:A,loading:z,loadingMore:K,loadingText:S,multiple:M,noOptionsText:O,onScroll:F,onSelect:H,query:T,selectedValues:Z,setItemRef:Q,statusClassName:I,value:C}=e,D=Vo({density:i}),w=z&&x.length===0,ee=!z&&x.length===0,U=new Set(Z);return o.jsxs(Mo,{ref:p,id:A,role:"listbox","aria-label":"Suggestions","aria-multiselectable":M||void 0,"aria-busy":z||K||void 0,density:i,query:T,highlightMatches:!0,className:Ea(D.wrapper,R),style:b,onScroll:F,...c,children:[x.map((B,q)=>{const W=M?U.has(B.value):C===B.value;return o.jsx(Fo,{id:`${n}-option-${q}`,ref:j=>Q(q,j),disabled:B.disabled,selected:W,density:i,before:M?o.jsx(Lo,{name:W?"checkbox-checked":"checkbox",fill:W?"icon":"icon.subtlest",display:"block","aria-hidden":!0}):void 0,label:B.label,description:B.description,iconBefore:B.iconLeft,iconAfter:B.iconRight,highlightMatches:!B.created,tabIndex:-1,bg:t===q?"bg.neutral.hovered":void 0,"data-active":t===q||void 0,...E({onMouseDown:j=>j.preventDefault(),onClick:()=>{B.disabled||H(B)}})},`${B.created?"create":"option"}-${B.value}`)}),w&&o.jsx(u,{className:I,role:"status",children:S}),ee&&o.jsx(u,{className:I,role:"status",children:O}),K&&o.jsx(u,{className:I,role:"status",children:S})]})};Va.__docgenInfo={description:"",methods:[],displayName:"AutocompleteListbox",props:{activeIndex:{required:!0,tsType:{name:"union",raw:"number | null",elements:[{name:"number"},{name:"null"}]},description:""},baseId:{required:!0,tsType:{name:"string"},description:""},density:{required:!0,tsType:{name:"ListItemVariantProps['density']",raw:"ListItemVariantProps['density']"},description:""},floatingProps:{required:!0,tsType:{name:"Record",elements:[{name:"string"},{name:"unknown"}],raw:"Record<string, unknown>"},description:""},floatingRef:{required:!0,tsType:{name:"RefCallback",elements:[{name:"HTMLDivElement"}],raw:"RefCallback<HTMLDivElement>"},description:""},floatingStyles:{required:!0,tsType:{name:"CSSProperties"},description:""},getItemProps:{required:!0,tsType:{name:"signature",type:"function",raw:"(props: HTMLProps<HTMLElement>) => Record<string, unknown>",signature:{arguments:[{type:{name:"HTMLProps",elements:[{name:"HTMLElement"}],raw:"HTMLProps<HTMLElement>"},name:"props"}],return:{name:"Record",elements:[{name:"string"},{name:"unknown"}],raw:"Record<string, unknown>"}}},description:""},items:{required:!0,tsType:{name:"unknown"},description:""},listboxClassName:{required:!0,tsType:{name:"string"},description:""},listboxId:{required:!0,tsType:{name:"string"},description:""},loading:{required:!0,tsType:{name:"boolean"},description:""},loadingMore:{required:!0,tsType:{name:"boolean"},description:""},loadingText:{required:!0,tsType:{name:"ReactNode"},description:""},multiple:{required:!0,tsType:{name:"boolean"},description:""},noOptionsText:{required:!0,tsType:{name:"ReactNode"},description:""},onScroll:{required:!0,tsType:{name:"UIEventHandler",elements:[{name:"HTMLDivElement"}],raw:"UIEventHandler<HTMLDivElement>"},description:""},onSelect:{required:!0,tsType:{name:"signature",type:"function",raw:"(option: AutocompleteOptionData) => void",signature:{arguments:[{type:{name:"signature",type:"object",raw:`{
  value: string;
  label: string;
  disabled?: boolean;
  description?: string;
