import{j as e}from"./jsx-runtime-D_zvdyIk.js";import{u as r}from"./index-CnaLoeUv.js";import{M as d,U as c}from"./index-CeGi0XfA.js";import"./index-BKyFwriW.js";import{F as l,G as a}from"./dsComponent-BYUIyF_R.js";import{D as i}from"./Divider-DhAaijX4.js";import{T as t}from"./Text-5drP39ES.js";import"./iframe-Dz2NKbl2.js";import"./index-CxmYaGqE.js";import"./_commonjsHelpers-CqkleIqs.js";import"./index-DQw2Bw4b.js";import"./index-DgH-xKnr.js";import"./index-DrFu-skq.js";import"./Tooltip-BvgCFTJi.js";function o(n){const s={code:"code",h1:"h1",h3:"h3",li:"li",ol:"ol",p:"p",pre:"pre",strong:"strong",ul:"ul",...r(),...n.components};return e.jsxs(e.Fragment,{children:[e.jsx(d,{title:"Docs / Build Reasoning"}),`
...
`,e.jsxs(s.li,{children:["Keep the Panda preset in its own ",e.jsx(s.code,{children:"./preset"})," entrypoint so the component runtime does not depend on Panda build tooling."]}),`
...
`,e.jsxs(s.li,{children:["The preset is available from ",e.jsx(s.code,{children:"cetec-design-system/preset"})," rather than the component runtime entrypoint."]}),`
...
`,e.jsx(s.li,{children:"The preset entrypoint keeps its Panda types isolated from component-only consumers."}),`
`]}),e.jsx(s.h3,{id:"distribution-output",children:"Distribution Output"}),e.jsxs(s.p,{children:["The expected ",e.jsx(s.code,{children:"dist"})," shape includes separate component and preset bundles. Component consumers use the root entrypoint, while Panda configuration imports the build-time preset from ",e.jsx(s.code,{children:"cetec-design-system/preset"}),"."]}),e.jsx(s.pre,{children:e.jsx(s.code,{className:"language-jsx",children:`dist/
