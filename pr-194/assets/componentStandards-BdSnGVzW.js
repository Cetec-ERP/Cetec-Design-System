import{j as e}from"./jsx-runtime-D_zvdyIk.js";import{u as t}from"./index-XMfWpo_L.js";import{M as c,U as a}from"./index-Dv0ltzeD.js";import"./index-BKyFwriW.js";import{F as d}from"./dsComponent-D6ec2IT1.js";import{D as s}from"./Divider-CFbTUo5C.js";import{L as o}from"./Link-B_W8b6O5.js";import"./iframe-mpVacJ4B.js";import"./index-CxmYaGqE.js";import"./_commonjsHelpers-CqkleIqs.js";import"./index-DQw2Bw4b.js";import"./index-DgH-xKnr.js";import"./index-DrFu-skq.js";import"./Icon-12cJPaFt.js";function r(i){const n={code:"code",h1:"h1",h2:"h2",p:"p",pre:"pre",...t(),...i.components};return e.jsxs(e.Fragment,{children:[e.jsx(c,{title:"Docs / Component Standards"}),`
`,e.jsx(a,{children:e.jsxs(d,{direction:"column",gap:"16",children:[e.jsx(n.h1,{id:"component-standards",children:"Component Standards"}),e.jsxs(n.p,{children:["This page is the short version: one rule, a brief reason, and a real example. The deeper standards live in ",e.jsx("code",{children:"/standards"})," and the related Storybook docs linked below."]}),e.jsx(s,{weight:"thick",color:"border.disabled",my:"48"}),e.jsxs(n.h2,{id:"1-start-prop-types-from-boxprops-and-recipe-variant-props",children:["1. Start prop types from ",e.jsx(n.code,{children:"BoxProps"})," and recipe variant props"]}),e.jsxs(n.p,{children:["Use ",e.jsx("code",{children:"Omit<BoxProps, keyof VariantProps>"})," first, then add component-specific props. This keeps HTML props, ",e.jsx(n.code,{children:"as"}),", and ref typing consistent."]}),e.jsx(n.pre,{children:e.jsx(n.code,{className:"language-tsx",children:`export type ChipProps = Omit<BoxProps, keyof ChipVariantProps> &
  ChipVariantProps & {
    // ...
  };
`})}),e.jsxs(n.p,{children:["Related: ",e.jsx(o,{href:"/?path=/docs/docs-controlled-and-uncontrolled-components-philosophy--documentation",children:"Controlled and Uncontrolled Components Philosophy"})]}),e.jsx(s,{weight:"thick",color:"border.disabled",my:"48"}),e.jsxs(n.h2,{id:"2-render-through-box-not-raw-html",children:["2. Render through ",e.jsx(n.code,{children:"Box"}),", not raw HTML"]}),e.jsx(n.p,{children:"Components should use the design-system base primitive so polymorphism, style props, and ref handling stay consistent."}),e.jsx(n.pre,{children:e.jsx(n.code,{className:"language-tsx",children:`return (
  <Box
    as="button"
    ref={buttonRef}
...
`})}),e.jsxs(n.p,{children:["Related: ",e.jsx(o,{href:"/?path=/docs/docs-floating-ui-architecture--documentation",children:"Floating UI Architecture"})]})]})})]})}function C(i={}){const{wrapper:n}={...t(),...i.components};return n?e.jsx(n,{...i,children:e.jsx(r,{...i})}):r(i)}export{C as default};
