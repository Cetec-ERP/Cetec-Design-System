import{j as t}from"./jsx-runtime-D_zvdyIk.js";import{r as s}from"./index-BKyFwriW.js";import{f as Y,w as Z,e as T,u as ee}from"./index-DPYJpPba.js";import{m as te,a as ne,s as ae,f as re,b as oe,d as se,B as ce}from"./Box-hQsv43T0.js";import{C as ie}from"./Card-froQLtvM.js";import{L as K}from"./Label-E-JLjBSC.js";import{u as de}from"./FieldContext-D6URyQos.js";import{T as k}from"./Toggle-Bk_B4o8o.js";import"./_commonjsHelpers-CqkleIqs.js";import"./Icon-CeNev6VN.js";const h=ne("toggleInput",{},[]),V={},I=Object.keys(V),le=Object.assign(te(h.recipeFn),{__recipe__:!0,__name__:"toggleInput",__getCompoundVariantCss__:h.__getCompoundVariantCss__,raw:a=>a,variantKeys:I,variantMap:V,merge(a){return re(this,a)},splitVariantProps(a){return ae(a,I)},getVariantProps:h.getVariantProps}),o=a=>{const e=de(),{name:n,checked:r,defaultChecked:c,onChange:u,id:G,children:L,error:H,invalid:N,disabled:$,...z}=a,b=H??(e==null?void 0:e.error),J=N??(e==null?void 0:e.invalid),f=$??(e==null?void 0:e.disabled),[Q,W]=oe(z),X=s.useId(),y=G??X;return t.jsxs(K,{className:se(le({}),Q),htmlFor:y,error:b,disabled:f,...W,children:[t.jsx(k,{name:n,checked:r,defaultChecked:c,onChange:u,id:y,error:b,invalid:J,disabled:f}),L]})};o.__docgenInfo={description:`A toggle paired with a clickable label.
...
}`,...(O=(M=m.parameters)==null?void 0:M.docs)==null?void 0:O.source}}};const Ce=["Default","Uncontrolled","AllStates","ExPrimitiveOnly","ExSettingsGroup","A11yKeyboardInteraction"];export{m as A11yKeyboardInteraction,l as AllStates,i as Default,g as ExPrimitiveOnly,p as ExSettingsGroup,d as Uncontrolled,Ce as __namedExportsOrder,Ie as default};
